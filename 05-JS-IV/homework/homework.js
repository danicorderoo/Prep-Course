...
var produc = 1;
  ...
  for(let clave in objetoMisterioso){
    
    var ValObj = clave;

    if(ValObj === 'numeroMisterioso'){
      produc = objetoMisterioso[clave]*5;
    }
...
function sumarLikesDeUsuario (usuario) {
  ...
  for(var i = 0; i < usuario.posts.length; i++){
    ValSum = ValSum + usuario.posts[i].likes;
  }
